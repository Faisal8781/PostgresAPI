...
//   it('create method should add a Users', async () => {
//     //@ts-ignore
//     const result = await user.create({
//       user.firstname: 'Faisal',
//       user.lastname: 'Alsulaiman',
...
//     const token =
//       'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoyLCJmaXJzdG5hbWUiOiJGYWlzYWwiLCJsYXN0bmFtZSI6IkFsaHJiaSIsInBhc3N3b3JkIjoiJDJiJDEwJENWRE5CaE4yeno2clM3M3EvZ1djcE8wRGZzNGJXSnVFS2RqaFU5NkhtZnlJcFpodC42VWp1In0sImlhdCI6MTcwNDM2Nzk3Mn0.7i9jnhubj1ofARS5cbR6pd0MBTvoX2rN-Bx35vR7I24';
...
//     const response = await request(app).get('/users/1').send({ token });
